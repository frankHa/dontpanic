...
{
    KAboutData about("dontpanik", 0, ki18n("Don't Panik"), version, ki18n(description), KAboutData::License_GPL, ki18n("(C) 2009 The Don't Panic Authors"), KLocalizedString(), 0, author_fh_email);
